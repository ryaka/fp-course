...
instance Applicative List where
  ...
  (<*>) ::
    ...
    -> List a
    -> List b
  -- List of functions and a list of a, need to map each function to a to get
  -- list of lists then flatten
...
lift2 ::
  ...
  -> k b
  -> k c
-- Apply function to inside of a then do applicative of that with b
lift2 f a b = f <$> a <*> b
